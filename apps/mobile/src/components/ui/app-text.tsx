...
const variantClasses: Record<NonNullable<AppTextProps["variant"]>, string> = {
  default: "font-sans text-base font-medium leading-6 text-app-text dark:text-app-text-dark",
  title: "font-sans text-5xl font-bold leading-[54px] text-app-text dark:text-app-text-dark",
  subtitle:
    "font-sans text-[28px] font-semibold leading-[34px] text-app-text dark:text-app-text-dark",
  small: "font-sans text-sm font-medium leading-5 text-app-text dark:text-app-text-dark",
  smallBold: "font-sans text-sm font-bold leading-5 text-app-text dark:text-app-text-dark",
  label:
    "font-sans text-sm font-bold uppercase tracking-[0.7px] leading-5 text-app-muted dark:text-app-muted-dark",
  link: "font-sans text-base font-semibold leading-6",
